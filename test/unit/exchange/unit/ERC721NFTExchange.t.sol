...
contract ERC721NFTExchangeTest is Test {
    ...
    function test_BatchBuyNFT_MultipleItems() public {
        ...
        uint256 takerFee1 = (prices[0] * TAKER_FEE_BPS) / BPS_DENOMINATOR;
        uint256 takerFee2 = (prices[1] * TAKER_FEE_BPS) / BPS_DENOMINATOR;
        uint256 totalPriceWithFees = prices[0] + takerFee1 + prices[1] + takerFee2;
    ...
    function test_GetterFunctions() public {
        ...
        // Test getBuyerSeesPrice
        uint256 buyerPrice = exchange.getBuyerSeesPrice(listingId);
        uint256 expectedPrice = price + (price * TAKER_FEE_BPS) / BPS_DENOMINATOR;
